...
void list_remove(List list, ListNode node) {
	...
	ListNode previous_node = list_first(list);
	for (ListNode temp_node = list_first(list); temp_node != LIST_EOF; temp_node = list_next(list ,temp_node)) {
...
void list_append(List list, List to_append) {
	...
	if (list_first(to_append) == LIST_BOF) {
